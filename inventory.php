...
<main>
  ...
  <div class="dashboard-main">
    ...
    <div class="d-flex flex-space-between flex-align-center mt-4 mx-3">
      <div>
        <input type="text" id="farmer-search" name="q" placeholder="Search Farmer Code" class="form-control" />
      </div>
    ...
    <div id="modal-stock-add" class="modal">
      <form action="/api/admin/stock/add.php" method="post" id="form-stock-add" class="card card-rect card-secondary text-center p-3">
