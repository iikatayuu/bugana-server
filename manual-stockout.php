...
$styles = ['/css/dashboard.css', '/css/manual-stockout.css'];
$scripts = ['/js/dashboard.js', '/js/manual-stockout.js'];
out_header('BUGANA Manual Stock Out', $styles, $scripts);
...
<main>
  <div class="sidebar">
    ...
    <a href="/order-management.php" class="sidebar-link headadmin-btns d-none">
      <svg width="16" height="16" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <div class="dashboard-main">
    ...
    <div class="d-flex flex-space-between flex-align-center mt-4 mx-3">
      ...
      <div class="mr-2">
        <a href="/stockout.php" class="btn btn-secondary text-md py-1" role="button">
          <img src="/imgs/left.svg" alt="Back" width="16" height="16" />
          <span>Back</span>
        </a>
      </div>
    ...
    <table class="dashboard-table">
      <thead>
        <tr>
          ...
          <th>
            <div class="d-flex flex-align-center flex-center">
              <span class="mr-1">Stock In Date</span>
              <div class="dropdown">
                <button type="button" class="btn btn-text" data-dropdown="toggle">
  ...
  <div id="modal-stock-in" class="modal">
    <form action="/api/admin/stock/update.php" method="post" id="form-stock-update" class="card card-rect text-center p-0">
      ...
      <div class="pb-2">
        ...
        <div id="form-stock-update-error"></div>
  ...
  <div id="modal-edited-successful" class="modal">
    <div class="card card-round-sm card-tertiary text-center p-0">
      <div class="d-flex flex-align-center mt-1 mx-2">
        <div class="flex-1"></div>
        <div class="modal-x">
          <button type="button" class="btn btn-text" data-modal="#modal-edited-successful">
      ...
      <div class="p-2">
        ...
        <div>Stocks has been edited successfully!</div>
      </div>
    </div>
  </div>
  ...
  <template id="temp-item">
    <tr>
      ...
      <td><span class="item-total-stocks"></span> KG</td>
      <td>
        <button type="button" class="item-edit-stock btn btn-secondary btn-sm text-sm">Edit Stock</button>
      </td>
    </tr>
  </template>
  ...
  <template id="temp-stock">
    <tr>
      ...
      <td>
        <div class="d-flex flex-align-center flex-space-around">
          <button type="button" class="quantity-btn d-none" data-decrement>-</button>
          <span class="stock-quantity">0</span>
          <button type="button" class="quantity-btn d-none" data-increment>+</button>
        </div>
      </td>
    </tr>
  </template>
