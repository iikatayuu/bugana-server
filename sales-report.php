...
<main>
  <div class="sidebar">
    ...
    <a href="/sales-report.php" class="sidebar-link active">
      <svg width="16" height="16" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <?php if ($is_detailed) { ?>
      ...
      <template id="temp-sale">
        <tr>
          ...
          <td>Php <span class="product-revenue"></span></td>
      ...
      <div class="card card-rect text-center mx-auto my-5 p-0 w-50">
        ...
        <div class="table-summary p-2">
          <table class="w-100">
            <tr>
              <td>Total Sales:</td>
              <td>Php <span id="total-sales">0</span></td>
              <td>
            ...
            <tr>
              ...
              <td>Php <span id="total-delivery-sales">0</span></td>
              <td></td>
            </tr>

            <tr>
              <td>Unsold Products:</td>
              <td>Php <span id="unsold-products"></span></td>
              <td>
            ...
            <tr>
              <td></td>
              <td>Total:</td>
              <td>Php <span id="report-total">0.00</span></td>
            </tr>
          </table>
        </div>
      </div>
  ...
  <div id="modal-product-breakdown" class="modal">
    <div class="card card-rect p-0 text-center">
      <div class="card-title-tertiary d-flex flex-align-center">
        <h3 class="text-center flex-1 text-lg">PRODUCT BREAKDOWN</h3>
        <div class="modal-x">
          <button type="button" class="btn btn-text" data-modal="#modal-product-breakdown">
      ...
      <?php if ($is_unsold) { ?>
        <div class="bd-product-title">"<span class="bd-product-title-text"></span>"</div>
      <?php } ?>
