...
<main>
  <div class="sidebar">
    ...
    <a href="/customer-violation-reports.php" class="sidebar-link active headadmin-btns d-none">
      <svg width="16" height="16" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <div id="modal-confirm-unban" class="modal">
    <div class="card card-round-sm card-tertiary text-center p-0">
      <div class="d-flex flex-align-center mt-1 mx-2">
        <div class="flex-1"></div>
        <div class="modal-x">
          <button type="button" class="btn btn-text" data-modal="#modal-confirm-unban">
      ...
      <div class="p-2 text-center">
        <div class="mb-3">Are you sure to unban this customer?</div>
        <div class="d-flex flex-space-around mx-4">
          <button type="button" class="btn btn-secondary mr-2" data-user="">Yes</button>
          <button type="button" class="btn btn-secondary" data-modal="#modal-confirm-unban">No</button>
        </div>
      </div>
    </div>
  </div>

  <div id="modal-unban-successful" class="modal">
    <div class="card card-round-sm card-tertiary text-center p-0">
      <div class="d-flex flex-align-center mt-1 mx-2">
        <div class="flex-1"></div>
        <div class="modal-x">
          <button type="button" class="btn btn-text" data-modal="#modal-unban-successful">
            <img src="/imgs/circle-x.svg" alt="Exit modal" width="24" height="24" />
          </button>
        </div>
      </div>
      ...
      <div class="p-2">
        ...
        <div>Account successfully unban!</div>
      </div>
    </div>
  </div>
  ...
  <template id="temp-user">
    <tr>
      ...
      <td class="counts"></td>
      <td>
        <button type="button" class="btn btn-secondary btn-sm text-sm user-actions" disabled>UNBAN</button>
      </td>
    </tr>
  </template>
</main>
